...
Download `nonfiction-v0.16.0.zip` from:
...
2. Copy `nonfiction-v0.16.0.zip` into this directory
3. Right-click `nonfiction-v0.16.0.zip`
...
tar -xf nonfiction-v0.16.0.zip
```

**macOS/Linux:**
```bash
cd /path/to/my-book
unzip nonfiction-v0.16.0.zip
```
...
```cmd
cd E:\Projects\my-book
tar -xf nonfiction-v0.16.0.zip --force-local
```

**macOS/Linux (with overwrite):**
```bash
cd /path/to/my-book
unzip -o nonfiction-v0.16.0.zip
```
